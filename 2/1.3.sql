...
--
-- Table structure for table `alltransport`
--

DROP TABLE IF EXISTS `alltransport`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `alltransport` (
  `id` int NOT NULL,
  `id_owner` int DEFAULT NULL,
  `brend_transport` varchar(45) DEFAULT NULL,
  `model_transport` varchar(45) DEFAULT NULL,
  `vin` varchar(45) DEFAULT NULL,
  `dateOFManufacture_Transport` date DEFAULT NULL,
  `price_allTransport` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `alltransport`
--

LOCK TABLES `alltransport` WRITE;
/*!40000 ALTER TABLE `alltransport` DISABLE KEYS */;
/*!40000 ALTER TABLE `alltransport` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `buyer` VALUES (1,'Dmitruy','Nikrasov','Ivanovich','2000-10-30','MALE','+79155460888'),(2,'Dmitruy','Nikrasov','Ivanovich','2000-10-30','MALE','+79155460888'),(3,'Oleg','Nikrasov','Ivanovich','2000-10-30','MALE','+79155460888');
...
INSERT INTO `car` VALUES (1,1,'BMW','e34','WBAPN7C52AA778342','1996-10-10',4500),(2,1,'BMW','e34','WBAPN7C52AA778342','1996-10-10',4500),(3,1,'BMW','e34','WBAPN7C52AA778342','1996-10-10',4500);
...
CREATE TABLE `saletable` (
  ...
  `brandTransport` int DEFAULT NULL,
  `modelTransport` int DEFAULT NULL,
  `vinTransport` varchar(45) DEFAULT NULL,
  `dateOfManufacture` varchar(45) DEFAULT NULL,
  `price` int DEFAULT NULL,
  `dateSale` date DEFAULT NULL,
  `idEmployee` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idSale`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `truck` VALUES (1,2,'Volvo','FH16','SKN42454434*12','2007-09-05',25000),(2,2,'Volvo','FH16','SKN42454434*12','2007-09-05',25000);
...
-- Dump completed on 2022-11-08 21:46:18
